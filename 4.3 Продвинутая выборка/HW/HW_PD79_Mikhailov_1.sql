...
-- Добавляем жанры
INSERT INTO jenre(jenre_name) values
('Rock'),
('Metall'),
('POP'),
('Hip-Hop'),
...
-- Делаем связку исполнителей с жанрами
INSERT INTO singer_jenre values
(1, 3),
(2, 1),
(3, 5),
(4, 2),
...
-- Добавляем альбомы
INSERT INTO album(album_name, album_years) VALUES 
('Cadillac', 2021), -- Морген
('Circus', 2008), -- Спирс
('In the Zone', 2003), -- Спирс
